...
--> statement-breakpoint
ALTER TABLE "blocks" DROP CONSTRAINT "day_exercise_unique_idx";
--> statement-breakpoint
ALTER TABLE "routines" DROP CONSTRAINT "routines_program_id_day_number_unique";
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "blocks"
ADD COLUMN "exercise_notes" text[] NOT NULL DEFAULT '{}'::text[];
--> statement-breakpoint
ALTER TABLE "blocks"
ADD COLUMN "name" varchar NOT NULL;
--> statement-breakpoint
ALTER TABLE "blocks"
ADD COLUMN "focus" varchar NOT NULL;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "blocks" DROP COLUMN IF EXISTS "routines_id";
--> statement-breakpoint
ALTER TABLE "blocks" DROP COLUMN IF EXISTS "reps";
--> statement-breakpoint
ALTER TABLE "blocks" DROP COLUMN IF EXISTS "rest_time";
--> statement-breakpoint
ALTER TABLE "blocks" DROP COLUMN IF EXISTS "order_index";
--> statement-breakpoint
ALTER TABLE "exercises" DROP COLUMN IF EXISTS "tempsReps";
--> statement-breakpoint
ALTER TABLE "programs" DROP COLUMN IF EXISTS "description";
--> statement-breakpoint
ALTER TABLE "programs" DROP COLUMN IF EXISTS "duration";
--> statement-breakpoint
ALTER TABLE "routines" DROP COLUMN IF EXISTS "program_id";
--> statement-breakpoint
ALTER TABLE "routines" DROP COLUMN IF EXISTS "day_number";
--> statement-breakpoint
